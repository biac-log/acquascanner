<template>
	<v-container fluid>
		...
		<v-alert :value="errorMessage != ''" class="mt-n5 mb-5" type="warning">{{ errorMessage }}</v-alert>
		<v-data-table
			:footer-props="{
		...
		<v-btn
			...
			class="mt-5"
			color="primary"
			@click="sendArticlesListe"
			:disabled="articles.length === 0"
		>Envoyer la liste</v-btn>
...
export default class ScanArticles extends Vue {
  ...
  private codeArticleIsFocus: boolean = false;
